...
package leaf.cosmere.feruchemy.client.render.renderer;
...
public class BraceletRenderer implements ICurioRenderer
{
	...
	{
		final ModelPart modelPart = Minecraft.getInstance().getEntityModels().bakeLayer(FeruchemyLayerDefinitions.BRACELET);
