...
public class FeruchemyLootFunctions
{
	...
	public static final LootItemFunctionTypeRegistryObject<InvestMetalmindLootFunction> INVEST_METALMIND =
			LOOT_FUNCTIONS.register("invest_metalmind", () -> InvestMetalmindLootFunction.CODEC);
