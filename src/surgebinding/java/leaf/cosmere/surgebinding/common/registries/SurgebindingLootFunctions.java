...
public class SurgebindingLootFunctions
{
	...
	public static final LootItemFunctionTypeRegistryObject<SetupShardDataLootFunction> SETUP_DATA = LOOT_FUNCTIONS.register("setup_shard", () -> SetupShardDataLootFunction.CODEC);
