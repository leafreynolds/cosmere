...
public class SurgebindingArgumentTypes
{
	public static final DeferredRegister<ArgumentTypeInfo<?, ?>> ARGUMENT_TYPE_INFOS =
			DeferredRegister.create(Registries.COMMAND_ARGUMENT_TYPE, Surgebinding.MODID);

	public static final DeferredHolder<ArgumentTypeInfo<?, ?>, ArgumentTypeInfo<?, ?>> RADIANT_ORDER_ARGUMENT_TYPE =
			ARGUMENT_TYPE_INFOS.register("radiant_order_argument_type",
