...
public class ShardplateModel extends HumanoidModel<LivingEntity>
{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.75F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.6F))
                .texOffs(0, 52).addBox(-5.0F, -15.5F, 1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(50, 33).addBox(3.0F, -15.5F, 1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.5F, 0.0F));
        ...
        PartDefinition right_arm_r3 = right_arm.addOrReplaceChild("right_arm_r3", CubeListBuilder.create().texOffs(24, 16).addBox(-1.4913F, -2.4945F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.7F))
                .texOffs(44, 27).addBox(-3.1984F, -2.9749F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(-2.5625F, 0.5446F, 0.0F, 0.0F, 0.0F, 0.6109F));
        ...
        PartDefinition left_arm_r3 = left_arm.addOrReplaceChild("left_arm_r3", CubeListBuilder.create().texOffs(30, 46).addBox(0.3418F, -3.1797F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.7F))
                .texOffs(42, 40).addBox(0.6347F, -2.6993F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.7F)), PartPose.offsetAndRotation(2.5625F, 0.7946F, 0.0F, 0.0F, 0.0F, -0.6109F));
        ...
        PartDefinition rightboot_outside = right_boot.addOrReplaceChild("rightboot_outside", CubeListBuilder.create().texOffs(0, 43).addBox(0.5F, -5.5F, -2.25F, 4.0F, 5.0F, 4.25F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightboot_tip = right_boot.addOrReplaceChild("rightboot_tip", CubeListBuilder.create().texOffs(24, 0).addBox(-3.75F, -2.5F, -4.75F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightleg = right_leg.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(16, 31).addBox(-4.35F, -11.6F, -2.1F, 4.0F, 11.25F, 4.0F, new CubeDeformation(0.4F)), PartPose.offset(1.9F, 12.0F, 0.0F));

        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.offset(1.9F, 12.0F, 0.0F));

        PartDefinition leftleg = left_leg.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(0, 28).addBox(0.35F, -11.6F, -2.1F, 4.0F, 11.25F, 4.0F, new CubeDeformation(0.4F)), PartPose.offset(-1.9F, 12.0F, 0.0F));

        PartDefinition left_boot = left_leg.addOrReplaceChild("left_boot", CubeListBuilder.create(), PartPose.offset(-1.9F, 12.0F, 0.0F));

        PartDefinition leftboot_outside = left_boot.addOrReplaceChild("leftboot_outside", CubeListBuilder.create().texOffs(40, 15).addBox(-4.5F, -5.5F, -2.25F, 4.0F, 5.0F, 4.25F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
