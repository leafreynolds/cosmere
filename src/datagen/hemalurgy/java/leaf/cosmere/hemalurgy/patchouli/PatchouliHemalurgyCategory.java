...
public class PatchouliHemalurgyCategory
{
	public static void collect(List<BookStuff.Category> categories, List<BookStuff.Entry> entries)
	{
		...
		pages.add(new BookStuff.CraftingPage("Spike Recipe", "hemalurgy:steel_spike", "hemalurgy:pewter_spike"));
		...
		for (Metals.MetalType metalType : Metals.MetalType.values())
		{
			...
			final String spikeItemLocation = String.format("hemalurgy:%s_spike", metalName);
