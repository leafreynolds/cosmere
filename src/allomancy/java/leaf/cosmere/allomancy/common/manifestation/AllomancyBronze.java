...
public class AllomancyBronze extends AllomancyManifestation
{
	...
	public static boolean isValidSeekTarget(ISpiritweb seeker, LivingEntity potentialConcealed)
	{
		...
		final Holder<Attribute> cognitiveConcealmentAttr = net.minecraft.core.registries.BuiltInRegistries.ATTRIBUTE.wrapAsHolder(AttributesRegistry.COGNITIVE_CONCEALMENT.get());
