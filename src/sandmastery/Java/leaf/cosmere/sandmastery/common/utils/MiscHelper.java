...
public class MiscHelper {
    public static boolean checkIfNearbyInvestiture(ServerLevel pLevel, BlockPos pPos) {
        ...
        for (LivingEntity targetEntity : entitiesToCheckForInvesiture)
        {
            ...
            if (mobEffect == null) copperEffect = null;
            else copperEffect = targetEntity.getEffect(mobEffect);
			if (copperEffect != null && copperEffect.getDuration() > 0) continue; //skip clouded entities.
