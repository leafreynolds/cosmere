...
import leaf.cosmere.sandmastery.common.items.*;
...
public class SandmasteryItems
{
	...
	public static final ItemRegistryObject<AnimatedItem> TEMPORARY_ANIMATED_ITEM = ITEMS.register("tmp_item", AnimatedItem::new);
}
