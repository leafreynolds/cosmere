...
public class KolossLargeRenderer extends MobRenderer<Koloss, KolossLargeModel<Koloss>>
{
	private static final ResourceLocation TEXTURE = Hemalurgy.rl("textures/entity/koloss/koloss_large.png");

	public KolossLargeRenderer(EntityRendererProvider.Context context)
	{
		super(context, new KolossLargeModel<>(context.bakeLayer(HemalurgyLayerDefinitions.KOLOSS_LARGE)), 1.0F);
