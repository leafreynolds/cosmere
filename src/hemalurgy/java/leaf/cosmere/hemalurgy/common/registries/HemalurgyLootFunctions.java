...
public class HemalurgyLootFunctions
{
	...
	public static final LootItemFunctionTypeRegistryObject<InvestSpikeLootFunction> INVEST_SPIKE = LOOT_FUNCTIONS.register("invest_spike", () -> InvestSpikeLootFunction.CODEC);
