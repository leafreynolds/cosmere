...
public interface IChargeable
{
	...
	{
		//todo clean up
		final Holder<MobEffect> aluminumStoreEffect = BuiltInRegistries.MOB_EFFECT
				.getHolder(ResourceLocation.fromNamespaceAndPath("feruchemy", "storing_" + Metals.MetalType.ALUMINUM.getName()))
