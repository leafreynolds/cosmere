...
public class VillagerProfessionDeferredRegister extends WrappedDeferredRegister<VillagerProfession>
{
	...
	{
		Predicate<Holder<PoiType>> heldJobSite = (poiType) -> poiType == poi.getRegistryObject();
		Predicate<Holder<PoiType>> acquirableJobSite = (poiType) -> poiType == poi.getRegistryObject();
