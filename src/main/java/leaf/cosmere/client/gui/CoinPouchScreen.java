...
{
	public CoinPouchScreen(CoinPouchContainer container, Inventory playerInv, Component title)
	{
	...
	protected void renderBg(PoseStack matrixStack, float partialTicks, int mouseX, int mouseY)
	{
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation(Cosmere.MODID, "textures/gui/coin_pouch.png"));
