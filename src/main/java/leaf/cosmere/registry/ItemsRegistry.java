...
{
	public static final DeferredRegister<net.minecraft.world.item.Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Cosmere.MODID);
	...
	public static final RegistryObject<net.minecraft.world.item.Item> NIGHT_BLOOD = ITEMS.register("night_blood", () -> createItem(new ShardbladeItem(Tiers.NETHERITE, 24, -1.4F, PropTypes.Items.SHARDBLADE.get())));
	public static final RegistryObject<net.minecraft.world.item.Item> TEST_BLADE = ITEMS.register("test_blade", () -> createItem(new ShardbladeItem(Tiers.NETHERITE, 10, -1.4F, PropTypes.Items.SHARDBLADE.get())));
	public static final RegistryObject<net.minecraft.world.item.Item> MASTER_SWORD = ITEMS.register("master_sword", () -> createItem(new ShardbladeItem(Tiers.NETHERITE, 10, -1.4F, PropTypes.Items.SHARDBLADE.get())));


	public static final RegistryObject<net.minecraft.world.item.Item> BANDS_OF_MOURNING = ITEMS.register("bands_of_mourning", () -> createItem(new BandsOfMourningItem()));
	...
	public static final RegistryObject<net.minecraft.world.item.Item> METAL_VIAL = ITEMS.register("metal_vial", () -> createItem(new MetalVialItem()));
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_RAW_ORE =
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_RAW_BLEND =
			Arrays.stream(Metals.MetalType.values())
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_NUGGETS =
			Arrays.stream(Metals.MetalType.values())
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_INGOTS =
			Arrays.stream(Metals.MetalType.values())
					.filter(Metals.MetalType::hasMaterialItem)
					.collect(Collectors.toMap(
							Function.identity(),
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_RINGS =
			Arrays.stream(Metals.MetalType.values())
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_BRACELETS =
			Arrays.stream(Metals.MetalType.values())
					.filter(Metals.MetalType::hasFeruchemicalEffect)
					.collect(Collectors.toMap(
							Function.identity(),
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_NECKLACES =
			Arrays.stream(Metals.MetalType.values())
					.filter(Metals.MetalType::hasFeruchemicalEffect)
					.collect(Collectors.toMap(
							Function.identity(),
	...
	public static final Map<Metals.MetalType, RegistryObject<net.minecraft.world.item.Item>> METAL_SPIKE =
			Arrays.stream(Metals.MetalType.values())
	...
	public static final Map<Roshar.Polestone, RegistryObject<net.minecraft.world.item.Item>> POLESTONE_CHIPS =
	...
	public static final Map<Roshar.Polestone, RegistryObject<net.minecraft.world.item.Item>> POLESTONE_MARKS =
			Arrays.stream(Roshar.Polestone.values())
					.collect(Collectors.toMap(
							Function.identity(),
							type -> ITEMS.register(
	...
	public static final Map<Roshar.Polestone, RegistryObject<net.minecraft.world.item.Item>> POLESTONE_BROAMS =
			Arrays.stream(Roshar.Polestone.values())
					.collect(Collectors.toMap(
							Function.identity(),
							type -> ITEMS.register(
